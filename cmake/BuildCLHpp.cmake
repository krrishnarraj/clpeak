...
set(CMK_EXTRA_ARGS "")
if(${CMAKE_GENERATOR_PLATFORM} NOT STREQUAL "")
  set(CMK_EXTRA_ARGS "-A ${CMAKE_GENERATOR_PLATFORM}")
endif()
file(MAKE_DIRECTORY ${DEPS} ${DEPS_BUILD})
file(WRITE "${DEPS}/CMakeLists.txt" "${CMAKE_LIST_CONTENT}")
execute_process(WORKING_DIRECTORY "${DEPS_BUILD}" COMMAND ${CMAKE_COMMAND} -G ${CMAKE_GENERATOR} ${CMK_EXTRA_ARGS} ..)
