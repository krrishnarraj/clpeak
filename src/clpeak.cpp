...
int clPeak::runComputeSP(cl::CommandQueue &queue, cl::Program &prog, device_info_t &devInfo)
{
    ...
    cl_float A = 8.2f, B = 65.0f;
    
    cl::Kernel kernel_v1(prog, "compute_sp_v1");
    kernel_v1.setArg(0, A), kernel_v1.setArg(1, B);
    
    cl::Kernel kernel_v2(prog, "compute_sp_v2");
    kernel_v2.setArg(0, A), kernel_v2.setArg(1, B);
    
    cl::Kernel kernel_v4(prog, "compute_sp_v4");
    kernel_v4.setArg(0, A), kernel_v4.setArg(1, B);
    
    cl::Kernel kernel_v8(prog, "compute_sp_v8");
    kernel_v8.setArg(0, A), kernel_v8.setArg(1, B);
    
    cl::Kernel kernel_v16(prog, "compute_sp_v16");
    kernel_v16.setArg(0, A), kernel_v16.setArg(1, B);
    ...
    ///////////////////////////////////////////////////////////////////////////
    // Vector width 1
    workPerWI = 64;      // Indicates flops executed per work-item
    ...
    // Vector width 2
    workPerWI = 128;      // Indicates flops executed per work-item
