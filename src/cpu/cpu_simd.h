...
// Every wrapper in this file is a one-line shim that MUST be inlined -- the
// compute chains measure hardware, and a call per operation measures the call.
// GCC does not reliably do it.  A CI codegen probe found `f64_div` emitted out
// of line (1 divide instruction in the whole TU against clang's 64), and after
// forcing just the div/sqrt shims it still called `f64_add` from inside the
// divider loop -- which also blocked `#pragma GCC unroll`, leaving 16 divides
// where clang emits 64.  The div/sqrt rows read ~22% of the hardware rate as a
// result.  Force the inline on all of them; they are all one-liners.
...
CPU_SIMD_ALWAYS_INLINE f32v f32_set(float a)            { return _mm512_set1_ps(a); }
CPU_SIMD_ALWAYS_INLINE f32v f32_load(const float *p)    { return _mm512_loadu_ps(p); }
CPU_SIMD_ALWAYS_INLINE f32v f32_fma(f32v a, f32v b, f32v c) { return _mm512_fmadd_ps(a, b, c); }
CPU_SIMD_ALWAYS_INLINE f32v f32_add(f32v a, f32v b)     { return _mm512_add_ps(a, b); }
CPU_SIMD_ALWAYS_INLINE float f32_hsum(f32v a)           { return _mm512_reduce_add_ps(a); }
...
CPU_SIMD_ALWAYS_INLINE f32v f32_set(float a)            { return _mm256_set1_ps(a); }
CPU_SIMD_ALWAYS_INLINE f32v f32_load(const float *p)    { return _mm256_loadu_ps(p); }
CPU_SIMD_ALWAYS_INLINE f32v f32_fma(f32v a, f32v b, f32v c) { return _mm256_fmadd_ps(a, b, c); }
CPU_SIMD_ALWAYS_INLINE f32v f32_add(f32v a, f32v b)     { return _mm256_add_ps(a, b); }
CPU_SIMD_ALWAYS_INLINE float f32_hsum(f32v a)
{
...
CPU_SIMD_ALWAYS_INLINE f32v f32_set(float a)            { return _mm_set1_ps(a); }
CPU_SIMD_ALWAYS_INLINE f32v f32_load(const float *p)    { return _mm_loadu_ps(p); }
CPU_SIMD_ALWAYS_INLINE f32v f32_fma(f32v a, f32v b, f32v c) { return _mm_add_ps(_mm_mul_ps(a, b), c); } // no FMA on SSE
CPU_SIMD_ALWAYS_INLINE f32v f32_add(f32v a, f32v b)     { return _mm_add_ps(a, b); }
CPU_SIMD_ALWAYS_INLINE float f32_hsum(f32v a)
{
...
constexpr int F32_NACC  = 24;
CPU_SIMD_ALWAYS_INLINE f32v f32_set(float a)            { return vdupq_n_f32(a); }
CPU_SIMD_ALWAYS_INLINE f32v f32_load(const float *p)    { return vld1q_f32(p); }
CPU_SIMD_ALWAYS_INLINE f32v f32_fma(f32v a, f32v b, f32v c) { return vfmaq_f32(c, a, b); }
CPU_SIMD_ALWAYS_INLINE f32v f32_add(f32v a, f32v b)     { return vaddq_f32(a, b); }
CPU_SIMD_ALWAYS_INLINE float f32_hsum(f32v a)           { return vaddvq_f32(a); }
#else
using f32v = float;
constexpr int F32_LANES = 1;
constexpr int F32_NACC  = 8;
CPU_SIMD_ALWAYS_INLINE f32v f32_set(float a)            { return a; }
CPU_SIMD_ALWAYS_INLINE f32v f32_load(const float *p)    { return *p; }
CPU_SIMD_ALWAYS_INLINE f32v f32_fma(f32v a, f32v b, f32v c) { return a * b + c; }
CPU_SIMD_ALWAYS_INLINE f32v f32_add(f32v a, f32v b)     { return a + b; }
CPU_SIMD_ALWAYS_INLINE float f32_hsum(f32v a)           { return a; }
#endif
...
CPU_SIMD_ALWAYS_INLINE f64v f64_set(double a)           { return _mm512_set1_pd(a); }
CPU_SIMD_ALWAYS_INLINE f64v f64_fma(f64v a, f64v b, f64v c) { return _mm512_fmadd_pd(a, b, c); }
CPU_SIMD_ALWAYS_INLINE f64v f64_add(f64v a, f64v b)     { return _mm512_add_pd(a, b); }
CPU_SIMD_ALWAYS_INLINE double f64_hsum(f64v a)          { return _mm512_reduce_add_pd(a); }
#elif defined(__AVX2__) && (defined(__FMA__) || defined(_MSC_VER))
using f64v = __m256d;
constexpr int F64_LANES = 4;
constexpr int F64_NACC  = 12;
CPU_SIMD_ALWAYS_INLINE f64v f64_set(double a)           { return _mm256_set1_pd(a); }
CPU_SIMD_ALWAYS_INLINE f64v f64_fma(f64v a, f64v b, f64v c) { return _mm256_fmadd_pd(a, b, c); }
CPU_SIMD_ALWAYS_INLINE f64v f64_add(f64v a, f64v b)     { return _mm256_add_pd(a, b); }
CPU_SIMD_ALWAYS_INLINE double f64_hsum(f64v a)
{
...
constexpr int F64_NACC  = 12;
CPU_SIMD_ALWAYS_INLINE f64v f64_set(double a)           { return _mm_set1_pd(a); }
CPU_SIMD_ALWAYS_INLINE f64v f64_fma(f64v a, f64v b, f64v c) { return _mm_add_pd(_mm_mul_pd(a, b), c); }
CPU_SIMD_ALWAYS_INLINE f64v f64_add(f64v a, f64v b)     { return _mm_add_pd(a, b); }
CPU_SIMD_ALWAYS_INLINE double f64_hsum(f64v a)          { return _mm_cvtsd_f64(_mm_add_sd(a, _mm_unpackhi_pd(a, a))); }
#elif defined(__aarch64__) || defined(_M_ARM64)
using f64v = float64x2_t;
constexpr int F64_LANES = 2;
constexpr int F64_NACC  = 24;   // same latency-hiding rationale as fp32
CPU_SIMD_ALWAYS_INLINE f64v f64_set(double a)           { return vdupq_n_f64(a); }
CPU_SIMD_ALWAYS_INLINE f64v f64_fma(f64v a, f64v b, f64v c) { return vfmaq_f64(c, a, b); }
CPU_SIMD_ALWAYS_INLINE f64v f64_add(f64v a, f64v b)     { return vaddq_f64(a, b); }
CPU_SIMD_ALWAYS_INLINE double f64_hsum(f64v a)          { return vaddvq_f64(a); }
#else
using f64v = double;
constexpr int F64_LANES = 1;
constexpr int F64_NACC  = 8;
CPU_SIMD_ALWAYS_INLINE f64v f64_set(double a)           { return a; }
CPU_SIMD_ALWAYS_INLINE f64v f64_fma(f64v a, f64v b, f64v c) { return a * b + c; }
CPU_SIMD_ALWAYS_INLINE f64v f64_add(f64v a, f64v b)     { return a + b; }
CPU_SIMD_ALWAYS_INLINE double f64_hsum(f64v a)          { return a; }
#endif
...
CPU_SIMD_ALWAYS_INLINE i32v i32_set(int a)              { return _mm512_set1_epi32(a); }
CPU_SIMD_ALWAYS_INLINE i32v i32_madd(i32v a, i32v b, i32v c) { return _mm512_add_epi32(_mm512_mullo_epi32(a, b), c); }
CPU_SIMD_ALWAYS_INLINE i32v i32_add(i32v a, i32v b)     { return _mm512_add_epi32(a, b); }
CPU_SIMD_ALWAYS_INLINE int   i32_hsum(i32v a)           { return _mm512_reduce_add_epi32(a); }
#elif defined(__AVX2__)
using i32v = __m256i;
constexpr int I32_LANES = 8;
constexpr int I32_NACC  = 12;
CPU_SIMD_ALWAYS_INLINE i32v i32_set(int a)              { return _mm256_set1_epi32(a); }
CPU_SIMD_ALWAYS_INLINE i32v i32_madd(i32v a, i32v b, i32v c) { return _mm256_add_epi32(_mm256_mullo_epi32(a, b), c); }
CPU_SIMD_ALWAYS_INLINE i32v i32_add(i32v a, i32v b)     { return _mm256_add_epi32(a, b); }
CPU_SIMD_ALWAYS_INLINE int   i32_hsum(i32v a)
{
...
constexpr int I32_NACC  = 12;
CPU_SIMD_ALWAYS_INLINE i32v i32_set(int a)              { return _mm_set1_epi32(a); }
CPU_SIMD_ALWAYS_INLINE i32v i32_madd(i32v a, i32v b, i32v c) { return _mm_add_epi32(_mm_mullo_epi32(a, b), c); } // mullo = SSE4.1
CPU_SIMD_ALWAYS_INLINE i32v i32_add(i32v a, i32v b)     { return _mm_add_epi32(a, b); }
CPU_SIMD_ALWAYS_INLINE int   i32_hsum(i32v a)
{
...
CPU_SIMD_ALWAYS_INLINE i32v i32_set(int a)              { return vdupq_n_s32(a); }
CPU_SIMD_ALWAYS_INLINE i32v i32_madd(i32v a, i32v b, i32v c) { return vmlaq_s32(c, a, b); }
CPU_SIMD_ALWAYS_INLINE i32v i32_add(i32v a, i32v b)     { return vaddq_s32(a, b); }
CPU_SIMD_ALWAYS_INLINE int   i32_hsum(i32v a)           { return vaddvq_s32(a); }
#else
using i32v = int;
constexpr int I32_LANES = 1;
constexpr int I32_NACC  = 8;
CPU_SIMD_ALWAYS_INLINE i32v i32_set(int a)              { return a; }
// Use unsigned arithmetic so wrap is well-defined (signed overflow is UB).
CPU_SIMD_ALWAYS_INLINE i32v i32_madd(i32v a, i32v b, i32v c)
{ return (int)((unsigned)a * (unsigned)b + (unsigned)c); }
CPU_SIMD_ALWAYS_INLINE i32v i32_add(i32v a, i32v b)     { return (int)((unsigned)a + (unsigned)b); }
CPU_SIMD_ALWAYS_INLINE int   i32_hsum(i32v a)           { return a; }
#endif
