...
{
    float4 A = (_A, (_A+1), (_A+2), (_A+3));
    float4 B = (_B, (_B+1), (_B+2), (_B+3));
...
{
    float8 A = (_A, (_A+1), (_A+2), (_A+3), (_A+4), (_A+5), (_A+6), (_A+7));
    float8 B = (_B, (_B+1), (_B+2), (_B+3), (_B+4), (_B+5), (_B+6), (_B+7));
...
{
    float16 A = (_A, (_A+1), (_A+2), (_A+3), (_A+4), (_A+5), (_A+6), (_A+7),
                    (_A+8), (_A+9), (_A+10), (_A+11), (_A+12), (_A+13), (_A+14), (_A+15));
    float16 B = (_B, (_B+1), (_B+2), (_B+3), (_B+4), (_B+5), (_B+6), (_B+7),
    ...
    float2 t = (y.S01) + (y.S23) + (y.S45) + (y.S67) + (y.S89) + (y.AB) + (y.CD) + (y.EF);
