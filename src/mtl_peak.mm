...
// Workload constant: simdgroup_matrix kernels do 1024 outer iters of an
// 8x8x8 matmul per simdgroup.  Per simdgroup ops = 1024 * 1024 = 1,048,576;
// per thread (32 threads/simdgroup) = 32,768 ops.  Distinct from
// COOPMAT_WORK_PER_WI (which assumes 16x16x16) because Apple silicon's
// simdgroup_matrix is fixed at 8x8x8.
static const uint32_t MTL_SIMDGROUP_WORK_PER_WI = 32768;
